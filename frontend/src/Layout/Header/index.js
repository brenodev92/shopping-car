...
export default function Header() {
	return (
		<nav className="l-header navbar navbar-expand-lg navbar-dark bg-primary">
			<NavLink to="/lista-item" activeClassName="active" className="navbar-brand">
				Shopping-Car
			</NavLink>
			...
			<div className="collapse navbar-collapse" id="navbarColor01">
				<ul className="navbar-nav mr-auto">
					<li className="nav-item">
						<NavLink to="/lista-item" activeClassName="active" className="nav-link">
							Listar
						</NavLink>
					</li>
					<li className="nav-item">
						<NavLink to="/adicionar-item" activeClassName="active" className="nav-link">
							Adicionar
						</NavLink>
					</li>
				</ul>
